        ...
        <main>
            <div className = "flex flex-row justify-center border hover:shadow-sm rounded-sm p-5 cursor-pointer" onClick={() => router.push(`/product/${product.id}`)} > 
                <div className = "flex flex-col">
                    <div className ="w-18 ml-auto" onClick={(e) => {
                        e.stopPropagation();
                ...
                <div className = "flex flex-row gap-1">
                    ...
                    <div className = "flex flex-col justify-between m-3 flex-wrap">
                        ...
                        <div className = "flex flex-row justify-between items-center ml-5 m-4 gap-2 lg:gap-20"
                            onClick = {(e) => {
                                e.stopPropagation();
                            }}>
                            <Badge className = "rounded-sm p-2 text-2xl justify-center" variant = "outline">₹{product.price}</Badge>
                            <div className = "sm:flex items-center justify-between">
                                <Button className = "flex flex-row justify-between gap-3">
                                    <p className><ContactNow /></p>
                                </Button>
                            </div>
                        </div>
                    </div>
